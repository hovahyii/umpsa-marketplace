...
export default function Footer() {
    ...
    return (
        <footer className="border-t border-white/10 bg-slate-950 pt-16 pb-16">
            ...
            <div className="container mt-12 pt-8 border-t border-white/5 text-center text-slate-500 text-sm px-4">
